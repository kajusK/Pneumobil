...
typedef enum {
    ...
    CONFIG_UINT_RF_PERIOD_MS, /* Telemetry sending period */
...
typedef enum {
    ...
    CONFIG_BOOL_RF_ENABLED, /* If true, start sending rf data after boot */
    CONFIG_BOOL_COUNT,
} config_item_bool_t;
...
typedef enum {
    ...
    CONFIG_FLOAT_RF_POWER_DBM, /* RF power in dBm to be used for transmitting */
    CONFIG_FLOAT_COUNT,
} config_item_float_t;
