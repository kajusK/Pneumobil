...
typedef enum {
/* Generic commands*/
    COMM_CMD_SYSTEM_STATUS = 0x00,    /* Current systems status, sent periodically */
...
/* ECU commands*/
    ...
    COMM_CMD_GET_PNEU_VARS = 0x2a,    /* Read pneumatic systém values */
    COMM_CMD_PNEU_REINIT = 0x2b,    /* Reset all pneumatic initialization data */
...
extern bool Comm_ReadPneuParams(race_mode_t mode, uint8_t *filling_pct,
        uint16_t *deadtime_ms);
extern bool Comm_ReadPneuVars(uint16_t *piston_len);
extern bool Comm_SendPneuReinit(void);
extern bool Comm_SendReboot(comm_node_t node);
#endif
