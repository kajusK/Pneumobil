...
extern comm_error_t Comm_EcuSetPneuParams(const comm_ecu_pneu_params_t *payload);
extern comm_error_t Comm_EcuGetPneuParams(uint8_t mode, comm_ecu_pneu_params_t *response);
extern comm_error_t Comm_EcuReinit(uint32_t magic);
extern comm_error_t Comm_EcuGetPneuVars(uint16_t *piston_len);
#endif
